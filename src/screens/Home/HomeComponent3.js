...
const HomeComponent1 = () => {
  ...
  return (
    <View style={styles.mainvw}>
        ...
        <FlatList data={DATA} renderItem={renderItem} keyExtractor={item => item.text1}	style={{height:50,backgroundColor:'lime'}} horizontal/>

                    {/* <ScrollView style={styles.sv} 
                    nestedScrollEnabled horizontal showsVerticalScrollIndicator={false}> 
