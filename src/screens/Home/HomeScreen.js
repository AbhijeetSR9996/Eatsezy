...
import { View, Text, FlatList, TouchableOpacity, ScrollView, RefreshControl, Platform, PermissionsAndroid, ToastAndroid,Image } from 'react-native';
							...
							<FlatList
								...
								renderItem={({ item, idx }) => {
									return <View key={idx} style={styles.bubbleContainer}>
										{/* <QuickFilter
											item={item} id={idx} setSelected={setSelected} selected={selected} /> */}
									</View>
								}}
							/>
						</View>
						<View style={styles.vw6}>
							{
								...
								<View style={styles.vw7}>
                                    ...
                                    <TouchableOpacity
										...
										<Text style={styles.font2} onPress={seeAll}>See All</Text>
									</TouchableOpacity>
									
									<TouchableOpacity onPress={seeAll} style={styles.seeAllStyle3}>
										<Text style={styles.font2}>See All</Text>
									</TouchableOpacity>
